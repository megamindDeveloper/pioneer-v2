...
<section className="min-h-screen w-sm md-w-xl text-white flex flex-col justify-between px-4 sm:px-6 py-12 text-center">
  ...
  {/* Bottom Content */}
  <div className="flex flex-col items-center space-y-12 sm:space-y-3 mt-[13.5rem] pb-8">
    {/* Headings */}
    <div>
      <p className="text-[#AD2239] font-bold mb-2 text-sm sm:text-base md:text-md">
        {highlightedText}
      </p>
      <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-medium leading-tight sm:leading-none mb-2">
        {heading}
      </h2>
