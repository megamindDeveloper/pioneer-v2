...
export default function DriveAlertH320({
  ...
  return (
    <section className="min-h-screen text-white flex flex-col justify-between px-4 sm:px-6 py-12 text-center">
      {/* Top Icon */}
      <div className="pt-30 sm:pt-52 md:mb-[-3.5rem] mb-[6.5rem]  animate-fastpulse">
        <Image
          src="/productPageImages/driveAlertIcons/dangerIcon.svg"
          alt="Warning Icon"
          width={40}
          height={40}
          className="mx-auto w-[60px] h-[60px] sm:w-[150px] sm:h-[150px]"
        />
      </div>

      {/* Bottom Content */}
      <div className="flex flex-col w-[20rem] md:w-3xl items-center space-y-12 sm:space-y-4  lg:mt-[12rem] pb-8">
        {/* Headings */}
        <div>
