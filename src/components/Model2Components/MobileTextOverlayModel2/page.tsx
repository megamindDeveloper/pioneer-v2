  ...
  const overlays = {
    ...
    s6: (
      <div className="w-sm md:w-lg space-y-4">
        ...
        <Typography variant="overlay-heading" className="text-white text-center font-medium text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
          3" IPS Display
        </Typography>

        <Typography variant="overlay-subheading" className="text-pretty text-[#ABABAB] text-center max-w-xl mx-auto text-sm sm:text-base md:text-md">
