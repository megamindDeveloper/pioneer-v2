...
const animationData = [
  {
    time: 0.0,
    position: [0.0048, 1.22165, 0.4968],
  ...
  {
    time: 0.3333,
    position: [-0.0, 6.6768, 0.0038],
    quaternion: [-0.0000001, 0.70092404, 0.71323591, 0.0000003],
    fov: 43.6028,
  },
  {
    time: 0.375,
    position: [-0.1, 6.6768, 2.3],
...
export default function Blender2JSPageModel2() {
  ...
  return (
    <div id="blender2js-scroll-container-model2" ref={containerRef} style={{ height: "2000vh", width: "100%" }}>
      {!modelIsReady && (
