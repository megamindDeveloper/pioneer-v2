...
const animationData = [
  ...
  { time: 0.3333, position: [-0.0, 5.6768, -5.038], quaternion: [-0.0000001, 0.70092404, 0.71323591, 0.0000003], fov: 40 },
];
  ...
  useEffect(() => {
    ...
    loader.load("/modelImages/CommonModelImages/820 Screen.webp", (texture) => {
      ...
      const plane = new THREE.Mesh(
        new THREE.PlaneGeometry(0.065, 0.037),
      ...
      if (displayMountRef.current) {
        ...
        plane.position.set(0.004, 0.0025, 0);
