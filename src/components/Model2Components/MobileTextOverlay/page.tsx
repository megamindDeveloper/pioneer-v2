        ...
        <section className="relative min-h-screen text-white flex items-center justify-center px-12">
          <div className="text-center min-w-xl  sm:min-w-3xl px-22 sm:mt-1 mt-16 ">
            ...
            <p className="text-[#AD2239] font-bold text-sm sm:text-base md:text-lg mb-3">
              See the Road in High Definition
            </p>
            ...
            {/* Description */}
            <p className="text-[#ABABAB] text-sm sm:text-base md:text-md max-w-xs mx-auto  leading-relaxed">
              From morning commutes to late-night returns, the front camera
              records in sharp 2K while the rear captures in Full HD. Whether
              it’s a close call or a scenic stretch, you’ll have a clear,
              reliable record from both angles.
            </p>
          </div>
        </section>
      ),
    ...
    },
    {
      ...
      content: (
        <div className="">
          ...
          <p className="text-pretty text-[#ABABAB] text-center min-w-xs max-w-xl mx-auto">
            The lens captures more of what’s around you including lanes, nearby
            vehicles and surroundings so you get a complete view of every drive.
          </p>
        </div>
      ),
    },
