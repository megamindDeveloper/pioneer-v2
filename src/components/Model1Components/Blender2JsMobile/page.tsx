...
const animationData = [
  ...
  { time: 0.0417, position: [-0.1, 1.213, 0.48], quaternion: [0.02902204, -0.37, -0.0781377, 0.9276399], fov: 20 },
  // { time: 0.0417, position: [-0.1, 1.213, 0.48], quaternion: [0.02902204, -0.4, -0.0781377, 0.9276399], fov: 20 },
  { time: 0.122, position: [-0.1, 1.216, 0.32], quaternion: [-0.0, -0.75, 0.0000004, 0.61231], fov: 30 },
  ...
  { time: 0.2083, position: [-0.00, 1.2136, 0.1], quaternion: [0.0, 1.0, -0.00000004, 0.00000004], fov: 40 },
...
function Blender2JSScene({
  ...
  useEffect(() => {
    ...
    const imageFadeOut = 0.40;
    const videoFadeIn = 0.436;
    const videoMidpoint = 0.440;
