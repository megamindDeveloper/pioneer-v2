...
export default function Model3textOverlay({
  ...
  const textSections = [
    ...
    // },
    {
      start: 0.149, // When the camera is high above the car
      end: 0.185,
      position:
    ...
    {
      start: 0.21, // When the camera is high above the car
      end: 0.2377,
      position:
...

    {
      ...
      start: 0.3135, // When the camera is high above the car
      end: 0.3188,
    },
    // {
    ...
    {
      start: 0.91, // When the camera is high above the car
      end: 0.9307,
      top: "50%",
      left: "20%",
      position:
