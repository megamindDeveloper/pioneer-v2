  ...
  set1: [
    {
      ...
      answer:
        "The VREC-Z820DC captures footage in stunning 4K Ultra HD using a Sony STARVIS sensor, delivering exceptional detail and clarity in both day and night conditions.",
    },
    {
      question: "Can the VREC-Z820DC record while parked?",
      answer:
        "Absolutely. With the optional RD-HWK300 hardwire kit, the dash cam supports Parking Mode, which records incidents even when your vehicle is turned off.",
    },
    {
